...
export  function getCurpage(data){
    return request({
        url:'http://119.23.243.88:8888/getpage',
        method:'get',
        params:data
    })
}
export function changeItem(data){
    return request({
        url:'http://119.23.243.88:8888/changeitem',
        method:'post',
        data
    })
}
export function addItem(data){
    return request({
        url:'http://119.23.243.88:8888/additem',
        method:'post',
        data
    })
}
export function submitPushForm(data){
    return request({
        url:'http://119.23.243.88:8888/submitPushForm',
        method:'get',
        params:data
    })
}
export function refreshThings(data){
    return request({
        url:'http://119.23.243.88:8888/refreshthings',
        method:'get',
        params:data
    })
}
